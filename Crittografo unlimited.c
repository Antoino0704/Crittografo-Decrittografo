...
#include <conio.h>		//richiama libreria conio
...
main()				//definisci funzione main
{
	...
	printf("inserisci frase da cifrare: ");			//stampa a schermo c'ho che c'è tra parentesi
	gets(frase);			//la variabile frase assume valore da tastiera
	do {
	printf("\n\ninserisci chiave di cifratura: ");		//stampa a schermo c'ho che c'è tra parentesi
	...
	{
		if(frase[i]>126-key)			//se il valore  della variabile frase è maggiore dal risultato dell'operazione 126-key
		{
